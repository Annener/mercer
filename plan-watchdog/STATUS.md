...
| 4 | rag-indexer: интеграция watchdog в lifespan | [step-04-lifespan.md](step-04-lifespan.md) | ✅ завершён | bf47b3e85a0a3a721d545768c096e962ec2cb9ae | `main.py`: `+watchdog_loop`, `+StorageClient`, `+watchdog_task`; `docker-compose.yml`: `+WATCHDOG_INTERVAL_SEC`; `.env.example`: `+WATCHDOG_INTERVAL_SEC`; 2 unit-теста |
